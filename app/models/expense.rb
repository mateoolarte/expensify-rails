class Expense < ApplicationRecord
  ...
  scope :month_ago, -> (month_ago) { where(date: DateTime.now.months_ago(month_ago.to_i).beginning_of_month..DateTime.now.months_ago(month_ago.to_i).end_of_month).order(date: :desc) }
